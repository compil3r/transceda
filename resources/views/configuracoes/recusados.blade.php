		...
		<div class="row">
			<div class="menu-horizontal col-md-offset-2 col-xs-offset-2  col-sm-offset-2  col-lg-offset-2 col-md-8 col-xs-8 col-sm-8 col-lg-8">
				<ul class="nav nav-tabs nav-justified">
					...
					<li role="presentation" class="active"><a href="/saques/recusados"><span class="glyphicon glyphicon-remove-sign"></span>  Problemáticos</a></li>
				</ul>
			</div>
			<br>
		</div>
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-offset-2 col-xs-offset-2  col-sm-offset-2  col-lg-offset-2 col-md-8 col-xs-8 col-sm-8 col-lg-8">	
					...
					<p align="center" class="politica"> Não há saques recusados. </p>
					</div>
				</div>
				@endif
			</div>
