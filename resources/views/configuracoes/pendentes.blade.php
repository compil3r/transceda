		...
		<div class="row">
			<div class="menu-horizontal col-md-offset-2 col-xs-offset-2  col-sm-offset-2  col-lg-offset-2 col-md-8 col-xs-8 col-sm-8 col-lg-8">
				<ul class="nav nav-tabs nav-justified">
					<li role="presentation" class="active"><a href="/saques/pendentes"><span class="glyphicon glyphicon-question-sign"> </span> Pendentes</a></li>
					<li role="presentation"><a href="/saques/aprovados"> <span class="glyphicon glyphicon-ok-sign"></span>  Resolvidos</a></li>
			...
			<div class="col-md-12">
						...
						<tr> 
							...
							<td>
								<div class="btn-group" role="group" aria-label="...">
									<a href="/saques/aprovar/{{$saques->id}}" class="btn btn-xs btn-success"><span class="glyphicon glyphicon-ok"></span></a>
									<a href="/saques/recusar/{{$saques->id}}" class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-remove"></a></button>
								</div>
							</td>
						</tr> 
						@endforeach	
				...
				<div class="col-md-offset-2 col-xs-offset-2  col-sm-offset-2  col-lg-offset-2 col-md-8 col-xs-8 col-sm-8 col-lg-8">	
					<div class="alert alert-default" role="alert">
						<p align="center" class="politica"> Não há saques pendentes. </p>
					</div>
				</div>
				@endif
			</div>
